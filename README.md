...
(0, 9, 15, 26)
```
Σημείωση: ο αλγόριθμος βρίσκει τα μέγιστα k-δικτυώματα, αλλά μπορεί να επιστρέψει και άλλα. Στο τελευταίο παράδειγμα μπορείτε να παρατηρήσετε ότι το μέγιστο δικτύωμα είναι το `(0, 3, 4, 5, 7, 9, 11, 15, 26)`, το οποίο περιέχει τα υπόλοιπα. Αν θέλαμε να έχουμε *μόνο* τα μέγιστα k-δικτυώματα θα βρίσκαμε τις συνιστώσες του γράφου (connected components) τρέχοντας στο τέλος του αλγορίθμου μια σειρά κατά βάθος ή κατά πλάτος αναζητήσεων. Αλλά αυτό δεν το ζητάει η εκφώνηση.
